  ...
  ({ className, type, ...props }, ref) => {
    return (
      <input
        type={type}
        className={cn(
          "flex h-12 w-full rounded-lg border border-expanova-border bg-expanova-surface/50 px-4 py-3 text-sm text-white placeholder:text-white/40 transition-all duration-200",
